...
using WebAppAzureDBTest.Data;
using WebAppAzureDBTest.Models;

namespace WebAppAzureDBTest.Controllers
{
    public class TodosController : Controller
    {
        private readonly MySqlTestDbContext _context;

        public TodosController(MySqlTestDbContext context)
        {
            _context = context;
        }
